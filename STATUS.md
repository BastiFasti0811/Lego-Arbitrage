...
|---|---|---|---|---|
| Prod-Deploy-Pipeline (CI verify + SSH-Deploy) | [deploy.md](docs/deploy.md) 2026-06-29 | [deploy-production.yml](.github/workflows/deploy-production.yml): pytest, ruff, alembic check, Compose-/Caddy-Validierung, Deploy nach `/srv/lego-arbitrage`; Container liefen 11.08.; seit PR #13 (19.08.) läuft `alembic upgrade head` automatisch zwischen Build und Container-Tausch | WIRKSAM* | Deploy-Weg für den Fix ist vorhanden und scharf |
